...
const trafficPage = {
    ...
    image: '../../images/traffic2.jpg',
    description: [
        {
            title: "Infraction/ Ticket",
...
function TrafficIncidentsAccordian() {
    return (
        <div className="servicePageReqDiv">
                ...
                <AccordionDetails>
                    <Typography>
                        <ul className="accoridanUl">
                            {trafficPage.requirements.map(req => (
                                <li key={`${req}key`}
            ...
            <Accordion className="servicePageAccordian">
                ...
                <AccordionDetails>
                    <Typography className="insideAccordian">
                        <ul className="accoridanUl">
                            {trafficPage.billingInformation.map(bi => (
                                <li key={`${bi}key`}
                                    className="accordianLi">
                                    {bi}
                                </li>
            ...
            <Accordion className="servicePageAccordian">
                ...
                <AccordionDetails>
                    <Typography className="insideAccordian">
                        <ul className="accoridanUl">
                            {trafficPage.whatYoullNeed.map(wyn => (
                                <li key={`${wyn}key`}
                                    className="accordianLi">
                                    {wyn}
                                </li>
                ...
                <AccordionDetails>
                    <Typography className="insideAccordian">
                        ...
                        <ul className="courtFormUl">
                            {trafficPage.courtForms.map(form => (
