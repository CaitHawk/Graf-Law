        ...
        <div className="servicePageReqDiv">
                ...
                <AccordionDetails>
                    <Typography>
                        <ul className="accoridanUl">
                            {custodyPage.requirements.map(req => (
                                <li key={`${req}key`}
            ...
            <Accordion className="servicePageAccordian">
                ...
                <AccordionDetails>
                    <Typography className="insideAccordian">
                        <ul className="accoridanUl">
                            {custodyPage.billingInformation.map(bi => (
                                <li key={`${bi}key`}
                                    className="accordianLi">
                                    {bi}
                                </li>
            ...
            <Accordion className="servicePageAccordian">
                ...
                <AccordionDetails>
                    <Typography className="insideAccordian">
                        <ul className="accoridanUl">
                            {custodyPage.whatYoullNeed.map(wyn => (
                                <li key={`${wyn}key`}
                                    className="accordianLi">
                                    {wyn}
                                </li>
                ...
                <AccordionDetails>
                    <Typography className="insideAccordian">
                        ...
                        <ul className="courtFormUl">
                            {custodyPage.courtForms.map(form => (
