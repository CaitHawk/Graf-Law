        ...
        <main className="divorceMain">
            ...
            <div className="divorceMainDiv">
                <div className="divorceTopDiv">
                    <div className="divorceImageDescription">
                        <img className="divorceImage" src={image} alt="Divorce" />
                        <p>{divorcePage.description}</p>
                    </div>
                </div>
...
const divorcePage = {
    ...
    undertitle: "Specailizing in Contested, Uncontested, Semi-Contested and Military Divorces",
