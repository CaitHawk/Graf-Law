...
const willsandtrustsPage = {
    title: "Wills and Trusts",
    image: '../../images/willsandtrusts.jpg',
    description: [
        {
            title: "Will and Testiment",
...
function WillsAndTrustsAccordian() {
    return (
        <div className="servicePageReqDiv">
                ...
                <AccordionDetails>
                    <Typography>
                        <ul className="accoridanUl">
                            {willsandtrustsPage.requirements.map(req => (
                                <li key={`${req}key`}
            ...
            <Accordion className="servicePageAccordian">
                ...
                <AccordionDetails>
                    <Typography className="insideAccordian">
                        <ul className="accoridanUl">
                            {willsandtrustsPage.billingInformation.map(bi => (
                                <li key={`${bi}key`}
                                    className="accordianLi">
                                    {bi}
                                </li>
            ...
            <Accordion className="servicePageAccordian">
                ...
                <AccordionDetails>
                    <Typography className="insideAccordian">
                        <ul className="accoridanUl">
                            {willsandtrustsPage.whatYoullNeed.map(wyn => (
                                <li key={`${wyn}key`}
                                    className="accordianLi">
                                    {wyn}
                                </li>
                ...
                <AccordionDetails>
                    <Typography className="insideAccordian">
                        ...
                        <ul className="courtFormUl">
                            {willsandtrustsPage.courtForms.map(form => (
    ...
    return (
        <main className="servicePageMain">
            ...
            <div className="servicePageTitleDiv">
                <h1>{willsandtrustsPage.title}</h1>
            </div>
            <div className="servicePageMainDiv">
                <ul className="servicePageTopDiv">
                    {willsandtrustsPage.description.map(card => (
